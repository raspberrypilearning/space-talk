...
say [Γεια!] for [2] seconds // απόκρυψη της ομιλίας μετά από 2 δευτερόλεπτα
```
...
Εάν έχεις χρόνο όταν ολοκληρώσεις το έργο σου, είναι καλή ιδέα να προσθέσεις σχόλια στον κώδικά σου, ώστε να είναι πιο κατανοητός αργότερα. Δοκίμασε να προσθέσεις ένα σχόλιο τώρα. Κάνε δεξί κλικ (ή σε tablet, πάτησε παρατεταμένα) σε ένα μπλοκ στην περιοχή Κώδικα και επίλεξε **Προσθήκη σχολίου**.
